---
description: >-
  Thinking in vCon is a short-form video series arguing that conversations
  should be treated as governed, portable artifacts. This section collects the
  full episodes, source material, and clips.
---
...
{% embed url="https://www.youtube.com/playlist?list=PLaxNQ-GrpFLc" %}
The complete series in order — three talks and two short cuts.
{% endembed %}
...
{% content-ref url="the-conversational-graph.md" %}
[the-conversational-graph.md](the-conversational-graph.md)
{% endcontent-ref %}
