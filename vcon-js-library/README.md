---
description: The TypeScript / JavaScript implementation of vCon, parallel to the Python library.
---

# 🟦 vCon-JS Library

`vcon-js` is the TypeScript / JavaScript implementation of the vCon specification. It is a peer to the [Python `vcon` library](../vcon-library/README.md), targeting the same [`draft-ietf-vcon-vcon-core-02`](https://datatracker.ietf.org/doc/draft-ietf-vcon-vcon-core/) spec.
...
- ❌ Per-extension helpers. The Python library has `add_lawful_basis_attachment()` and `add_wtf_transcription_attachment()`; vcon-js does not. You add extension data by appending to the relevant array yourself. The [Extensions section](../extensions/README.md) shows what shape each extension requires.
...
- [Python vCon Library](../vcon-library/README.md) — the peer implementation
- [Extensions](../extensions/README.md) — the shape of each extension, useful when you need to add extension data manually in vcon-js
